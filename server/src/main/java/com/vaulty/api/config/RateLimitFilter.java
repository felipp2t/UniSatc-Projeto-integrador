...
import com.vaulty.api.exception.ApiErrorBody;
...
// limita brute-force/spam em login, cadastro e recuperacao de senha, igual ao authRateLimit do vaulty original (5 req/min)
@Component
